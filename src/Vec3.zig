...
pub fn mulScalar(self: *const Vec3, t: f64) Vec3 {
    return Vec3.init(t * self.e[0], t * self.e[1], t * self.e[2]);
}
...
const test_u = Vec3.init(-2.0, 6.0, 2.0);
const test_v = Vec3.init(3.0, -4.0, 1.0);
